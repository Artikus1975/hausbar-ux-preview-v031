...
function bindEvents(){
  ...
  els.recipeCategoryFilter.addEventListener('change', e => { state.recipeFilters.category = e.target.value; renderRecipes(); });
  els.recipeStyleFilter.addEventListener('change', e => { state.recipeFilters.style = e.target.value; renderRecipes(); });
  els.recipeFlavorFilter.addEventListener('change', e => { state.recipeFilters.flavor = e.target.value; renderRecipes(); });
  els.recipeMoodFilter.addEventListener('change', e => { state.recipeFilters.mood = e.target.value; renderRecipes(); });
